        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-8 shadow-sm">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs text-gray-400"><span className="px-3 bg-white dark:bg-gray-900">or continue with email</span></div>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
            ...
            <Link href="/signup" className="text-blue-600 dark:text-blue-400 font-medium hover:underline">Sign up free</Link>
          </p>
        </div>
      </div>
    </>
