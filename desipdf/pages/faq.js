...
const FAQS = [
  ...
  { q: 'What is the maximum file size?', a: 'For Free tier users, server-assisted tools support files up to 50 MB. For Premium users, the limit is increased to 4 GB. Browser-only tools are limited mainly by your device memory.' },
  ...
  { q: 'How long are my files stored?', a: 'Browser-only tools keep files on your device. Server-assisted tools use temporary processing for the requested conversion and clean up files automatically.' },
  { q: 'Are my files private?', a: 'Yes. PDFChampion is privacy-first: many tools run locally in your browser, and server-assisted tools process files only for the conversion you request.' },
